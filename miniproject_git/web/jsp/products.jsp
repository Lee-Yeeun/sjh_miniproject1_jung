  ...
  <div class="row py-lg-5">
    <div class="col-lg-6 col-md-8 mx-auto">
      ...
      <p>
        ...
        <a href="main.jhj" class="btn btn-secondary my-2">홈으로 돌아가기</a>
      </p>
    </div>
  </div>
</section>
          ...
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
<%--                  <a href="./product.jsp" class="btn btn-sm btn-outline-secondary">View</a>--%>
                  <a href="./product.jsp?id=<%=rs.getString("p_num")%>"
