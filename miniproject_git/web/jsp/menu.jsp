  ...
  <header class="blog-header py-3">
    ...
    <div class="nav-scroller py-1 mb-2">
      <div class="nav d-flex justify-content-between">
        <a class="p-2 link-secondary" href="#">example1</a>
        <a class="p-2 link-secondary" href="#">example2</a>
        <a class="p-2 link-secondary" href="#">example3</a>
        <a class="p-2 link-secondary" href="#">example4</a>
      </div>
    </div>
